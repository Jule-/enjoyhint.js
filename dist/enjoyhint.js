...
var EnjoyHint = exports.EnjoyHint = function EnjoyHint(_options) {
    ...
    var methods = {
        ...
        init: function init(options) {
            ...
            return this.each(function () {
                ...
                that.kinetic_stage = new _kinetic2.default.Stage({
                ...
                var enjoyhint_elements = [that.enjoyhint, $top_dis_events, $bottom_dis_events, $left_dis_events, $right_dis_events, that.$element_dis_events];
        ...
        render_label_with_shape: function render_label_with_shape(data, stopFunction, updateShapeData) {
        ...
        redo_events_near_rect: function redo_events_near_rect(rect) {
        ...
        disable_element_events: function disable_element_events() {
